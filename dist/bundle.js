...
function randomMix() {
  ...
  var options = '001111122233'.split('');
  options = shuffle(options); // let randomIndex = randomNumber(0, gens.length)

  var randomIndex = options[randomNumber(0, options.length)];
